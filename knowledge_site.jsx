    ...
    <div className="min-h-screen bg-[#0B1E3B] text-[#DDE2E7]">
      ...
      <section className="text-center px-6 py-16 md:py-24">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 text-white">
          Unlock AI. Dominate Your Data.
        </h1>
        <p className="text-lg md:text-xl text-[#DDE2E7] max-w-2xl mx-auto mb-8">
      ...
      <section className="bg-[#11243F] rounded-2xl p-8 md:p-12 mx-6 mb-12 shadow-xl">
        <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12 max-w-6xl mx-auto">
          <div className="flex-shrink-0 md:w-48">
            <img 
              src="/626b9121-05e6-484f-b211-acd837192d58.png" 
              alt="Maze Logo" 
      ...
      <section className="bg-[#1A2D4B] rounded-2xl p-8 md:p-12 mx-6 mb-12 shadow-xl">
        <div className="flex flex-col md:flex-row gap-8 items-center max-w-5xl mx-auto">
          <div className="flex-1">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#D35400] mb-4">🧠 VaultBubble</h2>
            <p className="text-base md:text-lg mb-6">
              A Chrome extension and local AI system to build your personal research vault. Ask questions about your saved pages, visualize topics, and organize your brain. Local storage. No cloud. No spying.
            </p>
            <Button className="bg-[#D35400] text-white hover:bg-orange-700">READ MORE &gt;</Button>
          </div>
          <div className="flex-shrink-0">
            <img 
              src="/e027072a-231f-495b-8438-9b39f7a5c1f2.png" 
              alt="VaultBubble Maze Logo" 
